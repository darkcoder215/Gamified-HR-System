    ...
    <div>
      ...
      <div className="mb-5 flex gap-2 rounded-pill bg-warm-gray p-1">
        {([['ranking', 'الترتيب', Trophy], ['badges', 'الأوسمة', Award]] as const).map(([id, label, Icon]) => (
          ...
          >
            {tab === id && (
              <motion.div layoutId="tab-bg" className="absolute inset-0 rounded-pill bg-black" style={{ zIndex: 0 }} />
            )}
            ...
            return (
              ...
              >
                <div
                  ...
                  style={{
                    background: unlocked ? b.color : 'var(--color-warm-gray)',
                ...
                {unlocked && (
                  <span className="mt-1 font-ui text-[10px] font-bold text-green">✓ مفتوح</span>
                )}
              </motion.div>
            );
          })}
